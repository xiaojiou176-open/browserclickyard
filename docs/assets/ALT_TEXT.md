# Public Visual Alt Text

Use these alt strings when Prooflane visuals are reused in README sections,
docs pages, release notes, or GitHub discussions.
...
| `prooflane-proof-stack.svg` | `Prooflane proof stack showing product story, contract truth, public-safe artifacts, and private-only runtime evidence boundaries.` |
| `prooflane-social-preview.svg` | `Prooflane social preview banner source art for the AI-native WebUI stress lab brand surface. The live GitHub social preview setting must be verified separately.` |
| `prooflane-social-preview.jpg` | `Prooflane social preview banner export for the AI-native WebUI stress lab brand surface. The live GitHub social preview setting must be verified separately.` |
