...
Should Pagestress continue to grow as a **browser release decision plane**, or
...
- The front door already speaks in release language:
  [README](../README.md), [Why Pagestress](../why-pagestress.md), and
...
- The live task board and existing master plan explicitly target
  `Pagestress Release Decision Plane`.
