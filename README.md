...
![Browserclickyard studio preview showing the launch-first operator path: Stress Lab first, then Runs and Blocks, then Flow Studio, with Advanced Review as the deeper governed layer behind the first visible result.](./docs/assets/browserclickyard-studio-preview.svg)
